...
K.PetFlash         = "PetFlash"
K.PetBorderShield  = "PetBorderShield"
K.PetSpark         = "PetSpark"
K.PetScale         = "PetScale"
K.PetX             = "PetX"
K.PetY             = "PetY"
...
K.PartyFlash         = "PartyFlash"
K.PartyBorderShield  = "PartyBorderShield"
K.PartySpark         = "PartySpark"
...
K.NameplateFlash         = "NameplateFlash"
K.NameplateBorderShield  = "NameplateBorderShield"
K.NameplateSpark         = "NameplateSpark"
...
K.PlayerFlash         = "PlayerFlash"
K.PlayerBorderShield  = "PlayerBorderShield"
K.PlayerSpark         = "PlayerSpark"
...
for key in pairs(K) do
	...
	elseif key:match("X$") or key:match("Y$") or key:match("Width$") or key:match("Height$") then
		D[key] = 0
	elseif key:match("Flash$") or key:match("BorderShield$") then
		D[key] = false
	else
		D[key] = true
	end
